...
PARSER.add_argument('-f', '--folder', default='/media/sf_Ubuntu_Shared_IA/S-Cycle-main-sed/parameters_files') #Don't forget to add this here!
#PARSER.add_argument('-f', '--folder', default='/media/sf_Ubuntu_Shared_IA/S-Cycle-main-sed/seedings_files')   
...
for i, yml in enumerate(CONFIG):
    ...
    outfolder = cfg['OutFolder'] + '/seedings'
    print(outfolder)
